...
"""
message_q_project documentation build configuration file.
...
project = 'message_q_project'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'edx-custom-plugin'
...
#
# html_title = 'message_q_project v0.1.0'
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'This plugin is used to listen the message queue',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'message_q_app'),
                os.path.join(root_path, 'message_q_app/migrations')])
